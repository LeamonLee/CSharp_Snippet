using IndustrialNetworks.FatekCom.Licenses;
using System;
    ...
    public class FatekCommunication : BaseFatekCommunication
    {
        ...
        {            
            try
            {
                ...
                if (!"OK".Equals(FaTekLicenseManager.License)) if (!"OK".Equals(FaTekLicenseManager.License)) this.timerLicence.Enabled = true;
        ...
        {            
            try
            {
                ...
                {
                    this.timerLicence.Interval = 0x36EE80;
                    //this.timerLicence.Interval = 2000;
                }
                if (!"OK".Equals(FaTekLicenseManager.License)) if (!"OK".Equals(FaTekLicenseManager.License)) this.timerLicence.Enabled = true;
        ...
        {
            FaTekLicenseManager.ShowLicenseForm();
        }
